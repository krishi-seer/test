  ...
  return (
    <div className="p-4 space-y-6">
      <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl p-6 text-white shadow-lg">
        ...
        <p className="text-blue-100">Get in touch with the Krishi-Seer team</p>
      </div>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-800">CodeCultivator</h3>
                  <p className="text-gray-600">Full Stack Developer & AI Specialist</p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">krishiseer@gmail.com</span>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">+91 7678099576</span>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <a href="https://github.com/manthan2907" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
                    github.com/manthan2907
                  </a>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <a href="https://linkedin.com/in/manthanpagaria" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
                    LinkedIn Profile
                  </a>
                </div>
              </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="border-none shadow-md text-center">
          <CardContent className="pt-6">
            ...
            <p className="text-sm text-gray-600">
              Open to collaborations with agricultural experts, researchers, and developers interested in AgTech.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-none shadow-md text-center">
          <CardContent className="pt-6">
            ...
            <p className="text-sm text-gray-600">
              Typically respond within 24-48 hours. For urgent matters, please mention "URGENT" in the subject.
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="border-none shadow-md">
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center p-3 bg-gray-50 rounded-lg">
              <div className="text-2xl mb-2">🤖</div>
              <div className="font-medium">AI/ML APIs</div>
            </div>
            <div className="text-center p-3 bg-gray-50 rounded-lg">
              <div className="text-2xl mb-2">🗄️</div>
