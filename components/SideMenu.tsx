...
export default function SideMenu({ isOpen, onClose }: SideMenuProps) {
  ...
  const menuItems = [
    ...
    { href: "/irrigation", icon: "💧", label: "Smart Irrigation", isNew: true },
    { href: "/fertilizer", icon: "🧪", label: "Fertilizer AI", isNew: true },
    ...
    { href: "/research", icon: "📚", label: "Research & References", isNew: true },
